...
urlpatterns = [
    ...
    path('delete-booking/<int:reservation_id>/', views.delete_booking, name='delete_booking'),
    ...
    path('reject-reservation/<int:reservation_id>/', views.reject_reservation, name='reject_reservation'),
